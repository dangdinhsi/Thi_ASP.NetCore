...
namespace WebApplication3.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new WebApplication3User { FullName = Input.FullName, Birthday = Input.Birthday, Gender = Input.Gender, RollNumber = Input.RollNumber, UserName = Input.Email, Email = Input.Email };
        ...
        private void SendMail(string receiveMail, string receiveName, string mailContent)
        {
            ...
            MailAddress from = new MailAddress("siddd00474@gmail.com", "My Admin");
            ...
            NetworkCredential myCreds = new NetworkCredential("siddd00474@gmail.com", "cddolkiazcirpajz", "");
